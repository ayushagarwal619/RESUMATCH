...
def display_skill_validation(analysis: Dict[str, Any]) -> None:
    ...
    st.markdown(
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1.2rem; margin-top: 1rem; margin-bottom: 2rem;">
            <div class="glass-card" style="text-align: center; padding: 1.2rem;">
                <div style="font-size: 2.2rem; font-weight: 800; color: white;">{total}</div>
            ...
            <div class="glass-card" style="text-align: center; padding: 1.2rem;">
                <div style="font-size: 2.2rem; font-weight: 800; color: var(--accent-green);">{len(validated)}</div>
            ...
            <div class="glass-card" style="text-align: center; padding: 1.2rem;">
                <div style="font-size: 2.2rem; font-weight: 800; color: var(--accent-purple);">{pct:.0f}%</div>
    ...
    <div style="margin-bottom: 1.5rem;">
        <h4 style="color: white; font-size: 1.1rem; font-weight: 700; margin-bottom: 10px;">Demonstrated Skills Verification</h4>
    </div>
    """, unsafe_allow_html=True)
