...
def render():
    ...
    <div style="margin-bottom: 2rem;">
        <h1 style="margin: 0; background: linear-gradient(135deg, #FFFFFF 40%, #C084FC 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent; font-weight: 800; font-size: 2.5rem; letter-spacing: -0.02em;">Resources & Tips</h1>
        <p style="margin: 6px 0 0 0; font-size: 1.05rem; color: var(--text-secondary); font-weight: 500;">Learn how to optimize your resume for applicant tracking systems.</p>
    </div>
    ...
    with col1:
        st.markdown("""
        <div class="glass-card" style="border-left: 4px solid var(--accent-green); border-color: var(--accent-green); padding: 1.5rem; height: 100%;">
            <h3 style="color: white; font-size: 1.25rem; font-weight: 700; margin-bottom: 1rem; display: flex; align-items: center; gap: 8px;">✅ Do's</h3>
    ...
    with col2:
        st.markdown("""
        <div class="glass-card" style="border-left: 4px solid var(--accent-red); border-color: var(--accent-red); padding: 1.5rem; height: 100%;">
            <h3 style="color: white; font-size: 1.25rem; font-weight: 700; margin-bottom: 1rem; display: flex; align-items: center; gap: 8px;">❌ Don'ts</h3>
            <ul style="color: var(--text-secondary); font-size: 0.95rem; line-height: 1.8; padding-left: 20px;">
    ...
    with tab1:
        ...
        <div class="glass-card" style="padding: 1.5rem; margin-top: 10px;">
            <h4 style="color: white; font-size: 1.1rem; font-weight: 700; margin-bottom: 12px;">Software Engineering & DevOps</h4>
    ...
    with tab2:
        st.markdown("""
        <div class="glass-card" style="padding: 1.5rem; margin-top: 10px;">
            <h4 style="color: white; font-size: 1.1rem; font-weight: 700; margin-bottom: 12px;">Management & Business Operations</h4>
            <div style="display: flex; flex-wrap: wrap; gap: 8px;">
    ...
    with tab3:
        st.markdown("""
        <div class="glass-card" style="padding: 1.5rem; margin-top: 10px;">
            <h4 style="color: white; font-size: 1.1rem; font-weight: 700; margin-bottom: 12px;">Creative Design & Product Strategy</h4>
            <div style="display: flex; flex-wrap: wrap; gap: 8px;">
    ...
    st.markdown("""
    <div class="glass-card" style="border-left: 4px solid var(--accent-purple); border-color: var(--accent-purple); padding: 1.5rem;">
        <h3 style="color: white; font-size: 1.2rem; font-weight: 700; margin-bottom: 0.5rem; display: flex; align-items: center; gap: 8px;">📋 Templates Coming Soon</h3>
